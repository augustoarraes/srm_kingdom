...
public class TaxaCambioModel implements Serializable{
	...
	public String toString() {
		return "TaxaCambioModel [id=" + id + ", moedaOrigem=" + moedaOrigem + ", idMoedaOrigem=" + idMoedaOrigem
				+ ", moedaDestino=" + moedaDestino + ", idMoedaDestino=" + idMoedaDestino + ", valorTaxa=" + valorTaxa
				+ ", data=" + data + "]";
	}
